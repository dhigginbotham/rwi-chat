...
scriptLoader.files = [
  ...
  //footer scripts
  {path:'/js/priv.client.js', name:'socket.client.priv.js', where:'foot', url: '/secret-society/chat', type: 'js'},
  {path:'/js/pub.client.js', name:'socket.client.pub.js', where:'foot', url: '/a/chat', type: 'js'},
  {path:'/js/helpers.client.js', name:'helpers.client.js', where:'foot', url: '/', type: 'js'},
  {path:'/js/scripts.client.js', name:'scripts.client.js', where:'foot', url: '/', type: 'js'},
